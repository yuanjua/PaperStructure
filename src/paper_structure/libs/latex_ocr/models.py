"""Encoder-Decoder models for LaTeX OCR."""
...
class EncoderDecoder:
    """Encoder-Decoder architecture for LaTeX formula recognition."""
...
class Decoder:
    """Decoder model with autoregressive generation."""
    ...
    def __call__(
        ...
        Args:
            start_tokens: Starting tokens for generation
