"""Preprocessing utilities for LaTeX OCR."""
...
class PreProcess:
    """Image preprocessing for LaTeX OCR."""
    
    def __init__(self, max_dims: List[int], min_dims: List[int]):
        """Initialize preprocessor.
        
        Args:
            max_dims: Maximum image dimensions [width, height]
            min_dims: Minimum image dimensions [width, height]
        """
    ...
    def pad(img: Image.Image, divable: int = 32) -> Image.Image:
        ...
        Also normalizes the image and inverts if needed.
        
        Args:
            img: Input PIL Image
            divable: Divisible value for padding
    ...
    def minmax_size(self, img: Image.Image) -> Image.Image:
        ...
        Args:
            img: Image to scale up/down
            
        Returns:
            Image with correct dimensionality
        """
    ...
    def transpose_and_four_dim(img: np.ndarray) -> np.ndarray:
        """Transpose image and add batch dimension.
